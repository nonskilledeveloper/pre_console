random_phrases = [
    ...
    "Putting the icing on the cake. The cake is not a lie...", //Hasta aquí revisión 28-11-22
...
function generateRandom(min = 1000, max = 5000) {
    ...
    // add with min value 
    rand = rand + min;
    console.log('El número random fue: '+rand);

    return rand;
}

function Random_MessagesInt(min = 0, max = 260) {
...
function sleep(ms) {
 ...
 async function title_change() {
    ...
    for (let i = 0; i < 10 ; i++) {
       ...
       await sleep(generateRandom());
       document.title = document.title+'.';
       document.getElementById('bash_prompt').innerHTML += '<label>'+random_phrases[Math.floor(Random_MessagesInt())]+'</label><br><br>'
    }
 }

 title_change().then( () => {
    window.location.replace('https://nonskilledeveloper.com'+window.location.pathname)
 })
